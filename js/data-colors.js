...
SICOMIX.data = (function() {
    try {
        ...
        const excelPaintCodes = [
            ...
            // Інші серії (PLUV, PLUV_LED, SX, SPTN, OTF, TPP, NST, ECVF, OTHER) — тут мають бути всі записи з оригінального файлу
            // Для стислості не наводжу повний перелік, але ви маєте скопіювати їх із старого файлу.
        ];
        ...
        const additives = [
            ...
            // Додатки EC та CF видалено, оскільки вони тепер у основному каталозі
        ];
