...
SICOMIX.data = (function() {
    try {
        ...
        const specialColors = {
            ...
            "25M": { uk: "FARBA SICO SICOPLAST NIEBIESKA BAZA", pl: "FARBA SICO SICOPLAST NIEBIESKA BAZA", en: "FARBA SICO SICOPLAST NIEBIESKA BAZA", color: "#4169E1" },
            "26/20": { uk: "FARBA SICO SICOPLAST PANTONE PROCESS BLUE", pl: "FARBA SICO SICOPLAST PANTONE PROCESS BLUE", en: "FARBA SICO SICOPLAST PANTONE PROCESS BLUE", color: "#0066CC" },
            "31/31": { uk: "FARBA SICO SICOPLAST ZIELONA (7720C)", pl: "FARBA SICO SICOPLAST ZIELONA (7720C)", en: "FARBA SICO SICOPLAST ZIELONA (7720C)", color: "#2E8B57" },
            "35M": { uk: "FARBA SICO SICOPLAST ZIELONA BAZA", pl: "FARBA SICO SICOPLAST ZIELONA BAZA", en: "FARBA SICO SICOPLAST ZIELONA BAZA", color: "#008000" },
            "55M": { uk: "FARBA SICO SICOPLAST POMARAŃCZOWA BAZA", pl: "FARBA SICO SICOPLAST POMARAŃCZOWA BAZA", en: "FARBA SICO SICOPLAST POMARAŃCZOWA BAZA", color: "#FFA500" },
            "60/12": { uk: "FARBA SICO SICOPLAST PANTONE 032C", pl: "FARBA SICO SICOPLAST PANTONE 032C", en: "FARBA SICO SICOPLAST PANTONE 032C", color: "#E31B23" },
            "65M": { uk: "FARBA SICO SICOPLAST CZERWONA", pl: "FARBA SICO SICOPLAST CZERWONA", en: "FARBA SICO SICOPLAST CZERWONA", color: "#FF0000" },
            "70/36": { uk: "FARBA SICO SICOPLAST RUBINE RED", pl: "FARBA SICO SICOPLAST RUBINE RED", en: "FARBA SICO SICOPLAST RUBINE RED", color: "#E31B23" },
        ...
        const excelPaintCodes = [
            ...
            { code: "TPP22", seriesId: "TPP", colorCode: "22" },
            ...
            { code: "NST100", seriesId: "NST", colorCode: "100" },
        ...
        function naturalSort(a, b) {
            const parseColorCode = (code) => {
                ...
                if (!match) return { main: 9999, sub: null, suffix: code };
                ...
                if (rest.startsWith('/')) {
                    ...
                    if (subMatch) {
                        sub = parseInt(subMatch[1], 10);
                        rest = rest.slice(subMatch[0].length);
                    }
                }
                
                let suffix = rest.trimStart();
                return { main, sub, suffix };
            };

            const aParts = parseColorCode(a.colorCode);
            const bParts = parseColorCode(b.colorCode);
