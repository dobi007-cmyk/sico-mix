...
export function translateCategory(categoryKey) {
    const categoryMap = {
...
export function translateCategoryName(ukrainianName) {
    const lang = currentLanguage;
...
export function localizeUnitSymbol(unit) {
    const unitMap = {
        'г': t('unit_g'),
        'кг': t('unit_kg'),
        'мл': t('unit_ml'),
