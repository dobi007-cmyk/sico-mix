    ...
    SICOMIX.app = (function() {
        ...
        function renderPaintCatalog(append = false) {
            ...
            try {
                ...
                // Обробник для кнопки інфо (показує деталі серії)
        ...
        // Функція додавання фарби з каталогу до нового рецепту
