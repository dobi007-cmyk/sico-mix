...
(function(global) {
    ...
    SICOMIX.pantone = {
        // Масив кольорів Pantone з формулами змішування
        colors: [
            ...
            // 13 U (декілька формул) – тимчасово об'єднано в один запис, але краще розділити
            ...
            { number: "712 U", name: "712 U", ingredients: [
                ...
                { name: "PANTONE Orange 021", amount: 0.06 }, // ймовірно помилка, має бути інший інгредієнт
        ...
        findByNumber: function(number) {
            return this.colors.find(c => c.number === number);
        },
